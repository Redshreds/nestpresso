...
export class CoffeesController {
  constructor(private readonly CoffeesService: CoffeeService) {} //Private access modifier allows us to declare and initialize, as well as only accesible in constructor itself. readonly suggests no modifying service allowed. best practice
